  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-[#b9bbb3] flex items-center">
              @your account
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <Mic className="size-5 text-[#b9bbb3] hover:text-white cursor-pointer" />
            <Headphones className="size-5 text-[#b9bbb3] hover:text-white cursor-pointer" />
            <Cog className="size-5 text-[#b9bbb3] hover:text-white cursor-pointer" />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        {/* dm header */}
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#0202225]">
