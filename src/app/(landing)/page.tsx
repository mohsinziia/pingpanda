...
const Page = () => {
  const codeSnippet = `await fetch("https://pingpandadiscord.vercel.app/api/v1/events", {
  method: "POST",
  body: JSON.stringify({
    category: "sale",
    fields: {
  ...
  return (
    <>
        ...
        <MaxWidthWrapper className="text-center">
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            ...
            <p className="text-base/7 text-gray-600 max-w-prose text-center text-pretty">
              Ping Panda is the easiest way to monitor your SaaS. Get instant
              notifications for{" "}
      ...
      <section className="relative bg-brand-25">
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative lg:row-span-2">
              <div className="absolute insex-px rounded-lg bg-white lg:rounded-l-[2rem]" />
